...
async function suggestHeadingWithGemini(lines, images, hints, env) {
  ...
  const prompt = [
    ...
    "For scanned non-Latin sources, trust the page image over OCR-like text when they conflict. Visually distinguish similar glyphs before filling names or publishers, and use filename hints only as cross-checks for bracketed Latin forms.",
